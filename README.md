...
<br><br> - <b>Raza bondadosa --></b> Pelosos(1), Sureños buenos(2), Enanos(3), Númenóreanos(4) y Elfos(5).
<br> - <b>Raza malvada --></b> Sureños malvados(2), Orcos(2), Goblins(2), Huargos(3) y Trolls(5).

El resultado puede ser que gane el bien, como que gane el mal o que haya un empate.

<br><br>Una posible salida del programa podría ser:
